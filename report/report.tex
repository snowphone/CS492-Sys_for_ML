...
Interesting result was shown at the beginning of the ‘session.run’. On CPU, it took 0.153 seconds to inference the first frame, while the average time was 0.0597.
Moreover, on the GPU, it took 1.252 seconds for the inference first frame and 0.103 for the second, while the average was 0.0154.
